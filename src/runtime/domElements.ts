...
export function getRuntimeElements(selectors: RuntimeSelectors) {
  return {
    ...
    eventLog: requiredElement<HTMLOListElement>(selectors.eventLog),
    menuButtons: document.querySelectorAll<HTMLButtonElement>(selectors.menuButtons),
    hitboxEditor: optionalElement<HTMLElement>(selectors.hitboxEditor),
    hitboxEditorAdd: optionalElement<HTMLButtonElement>(selectors.hitboxEditorAdd),
    hitboxEditorClose: optionalElement<HTMLElement>(selectors.hitboxEditorClose),
    hitboxEditorBody: optionalElement<HTMLElement>(selectors.hitboxEditorBody),
    hitboxEditorCopy: optionalElement<HTMLElement>(selectors.hitboxEditorCopy),
