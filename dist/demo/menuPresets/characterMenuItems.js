function hasMouthLayer(surface) {
    return Boolean(surface.layers?.mouth || surface.mouthImages);
}
function createMouthAnimationMenuItem(character) {
 ...
 */
export function createCharacterMenuItems(character) {
    return [
        {
            id: "jump",
            label: "점프",
...
//# sourceMappingURL=characterMenuItems.js.map