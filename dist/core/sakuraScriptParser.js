...
function readBracketValue(script, startIndex) {
...
function readDigits(script, startIndex) {
 ...
 */
export function parseSakuraScript(script) {
    const tokens = [];
    let textBuffer = "";
    let index = 0;
    const flushText = () => {
...
//# sourceMappingURL=sakuraScriptParser.js.map