...
export function initHitboxEditor({ elements, character }) {
    ...
    const editor = elements.hitboxEditor;
    ...
    elements.hitboxEditorAdd?.addEventListener("click", handleAddClick);
    elements.hitboxEditorClose?.addEventListener("click", handleCloseClick);
    elements.hitboxEditorCopy?.addEventListener("click", handleCopyClick);
    elements.stage.addEventListener("ghostnest:open-ui", handleOpenUi);
    cleanupCallbacks.push(() => {
        elements.hitboxEditorAdd?.removeEventListener("click", handleAddClick);
        elements.hitboxEditorClose?.removeEventListener("click", handleCloseClick);
        elements.hitboxEditorCopy?.removeEventListener("click", handleCopyClick);
